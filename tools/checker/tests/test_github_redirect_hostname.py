...
def load_epg_health():
    ...
    spec = importlib.util.spec_from_file_location(
        "process_epg_health_redirect_hostname",
        path,
    )
...
class GitHubRedirectHostnameTests(
    unittest.TestCase
):
    ...
    def test_stream_rejects_redirect_without_hostname(
        self,
    ):
    ...
    def test_epg_rejects_redirect_without_hostname(
        self,
    ):
        self.check_missing_hostname_is_rejected(
            epg_health
