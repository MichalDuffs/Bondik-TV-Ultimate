...
def load_epg_health():
    ...
    spec = importlib.util.spec_from_file_location(
        "process_epg_health_encoded_port_separator",
        path,
    )
...
class GitHubEncodedHostnamePortSeparatorTests(
    unittest.TestCase
):
    ...
    def test_stream_rejects_encoded_hostname_port_separator(
        self,
    ):
    ...
    def test_epg_rejects_encoded_hostname_port_separator(
        self,
    ):
        self.check_initial_url_is_rejected(
            epg_health
    ...
    def test_stream_rejects_encoded_redirect_hostname_port_separator(
        self,
    ):
    ...
    def test_epg_rejects_encoded_redirect_hostname_port_separator(
        self,
    ):
        self.check_redirect_is_rejected(
            epg_health
