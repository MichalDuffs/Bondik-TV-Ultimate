...
def load_epg_health():
    ...
    spec = importlib.util.spec_from_file_location(
        "process_epg_health_nested_hostname",
        path,
    )
...
class GitHubNestedHostnameEncodingTests(
    unittest.TestCase
):
    ...
    def check_redirect_is_rejected(
        ...
        redirected = handler.redirect_request(
            ...
            "Found",
            {},
            "https://api%252520github.test/target",
        )
    ...
    def test_stream_rejects_triple_encoded_hostname(
        self,
    ):
    ...
    def test_epg_rejects_triple_encoded_hostname(
        self,
    ):
        self.check_initial_url_is_rejected(
            epg_health
    ...
    def test_stream_rejects_triple_encoded_redirect_hostname(
        self,
    ):
    ...
    def test_epg_rejects_triple_encoded_redirect_hostname(
        self,
    ):
        self.check_redirect_is_rejected(
            epg_health
